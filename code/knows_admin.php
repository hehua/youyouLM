...
<div class="content">
       <div class="newslist">
         <span class="newslist_title">已发布常识</span><br><br><br>
         <?php 
	     ...
	     for( $i = 0; $i < count($data); $i++){
	     	...
	     	<div class="single_news">
              ...
              <span class="news_button"> <a href="knows_edit.php?name=<?php echo $i?>"> 编辑 </a></span> 
              <span class="news_button"> <a href="knows_del.php?name=<?php echo $i?>"> 删除 </a></span> 
            </div>
	     	<?php 
	     }
         ?>
       ...
       <div class="newsform">
       <form  method="post" action="knows_add.php">
           <span class="newsform_title">发布常识</span><br>
           <span class="choicel">常识标题:</span><input class="search_text" name="title" type="text"  /><br>
           <span class="choicel">常识内容:</span><br/><textarea id="resume" name="content" rows="18" cols="65"></textarea><br>
