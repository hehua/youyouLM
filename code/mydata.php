...
<div class="content">
       ...
       <div class="mydata">
         <span class="mydata_title">我的资料</span><br>
         <?php 
         $rightdata = $employ_list->get_eploy_data($eid);
         list($er, $myname, $pas,$phone,$email) = explode( '|' ,$rightdata);
         ?>
         <span class="mydata_line">用户名：<?php echo $er?></span><br>
         <span class="mydata_line">姓名：<?php echo $myname?></span><br>
         <span class="mydata_line">密码：<?php echo $pas?></span><br>
         <span class="mydata_line">电话：<?php echo $phone?></span><br>
         <span class="mydata_line">邮箱:<?php echo $email?></span><br>
       </div>
