...
<?php 
	...
	$mydata = list($mytitle, $mytime, $mycontent, $mye_id,$myreadyes ) = explode( '|' ,$appdata[$num]);
	//$applylist ->mark_read($mytitle,$mytime,$mye_id);
...
<div class="content">
       ...
       if($checknum !=0) {
       	?>
       	<span class="newslist_title">未处理请假申请(<?php echo $checknum?>)</span><br>
          <?php 
       ...
       ?>
         ...
         <span class="newslist_title">已处理请假申请</span><br>
         <?php 
          for( $i = 0; $i < count($appdata); $i++){
	     	list($title, $time, $content,$e_id,$readyes) = explode( '|' ,$appdata[$i]);
	     	$ename = $elist->get_eploy_name($e_id);
       ...
       <div class="news_content">
         ...
         <span class="news_content_c">&nbsp &nbsp<?php echo $mycontent?></span><br><br>
         <?php 
         ...
         if($myreadyes=='0'){
         	?>
         	<span class="news_button"><a href="apply_reply.php">答复</a></span>
         	<?php 
         }
         else{
         	?>
         	<span class="news_button">已答复</span>
         	<?php 
         }
         ?>
